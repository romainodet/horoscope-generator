document.addEventListener("DOMContentLoaded", function () {
    ...
    // Fonction pour actualiser les horoscopes
    function refreshHoroscopes() {
        // Effacez tous les horoscopes existants
        horoscopesContainer.innerHTML = "";

        // Récupérez les horoscopes pour chaque signe et les affichez à nouveau
    ...
    function activateDarkMode() {
        ...
        // Changez également la couleur de remplissage de l'icône du bouton de rafraîchissement en mode sombre
        const refreshIcon = document.getElementById('refresh-button').querySelector('svg');
        refreshIcon.style.fill = '#333'; // Couleur sombre
    }
    ...
    function deactivateDarkMode() {
        ...
        // Changez également la couleur de remplissage de l'icône du bouton de rafraîchissement en mode clair
        const refreshIcon = document.getElementById('refresh-button').querySelector('svg');
        refreshIcon.style.fill = '#fff'; // Couleur claire
    }
    ...
    refreshButton.addEventListener('click', () => {
        refreshHoroscopes(); // Actualisez les horoscopes lorsque le bouton est cliqué
    });
});
